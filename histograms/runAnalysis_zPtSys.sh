...
uncertainty="zPtUp"
sed -e 's/ZPtReweightingScale = 0/ZPtReweightingScale = 1/g' analysisMacro_ztt_DY_ZTT.conf > analysisMacro_ztt_DY_ZTT_${uncertainty}.conf
sed -e 's/ZPtReweightingScale = 0/ZPtReweightingScale = 1/g' analysisMacro_ztt_DY_ZLL.conf > analysisMacro_ztt_DY_ZLL_${uncertainty}.conf
